            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.orders.export') }}" class="btn btn-success btn-lg shadow-sm"
                            id="exportBtn">
                                    ...
                                    <td class="text-center px-4">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.orders.show', $order->id) }}"
                                                class="btn btn-outline-info btn-sm action-btn action-btn-view"
                                                data-bs-toggle="tooltip" title="Xem chi tiết">
                                                <i class="fa-solid fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.orders.edit', $order->id) }}"
                                                class="btn btn-outline-warning btn-sm action-btn action-btn-edit"
                                            ...
                                            <button type="button"
                                                class="btn btn-outline-danger btn-sm action-btn action-btn-delete btn-delete"
